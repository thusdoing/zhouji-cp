                                ...
                                <tbody>
                                    <tr>
                                        <td v-for="(item,index) in gameList" :key="index+'b'">
                                            <p class="_3n4Tb" v-for="(sub,index) in item.gameSetting" :key="index+'c'" @click="$router.push({name:'skip',params:{gopath:`/bet/${sub.gameType}/${sub.gameNo}/${$ENV.IS_OFFICIAL?'official':'credit'}`}})">{{sub.gameName}}</p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
