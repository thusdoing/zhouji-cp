<template>
    <div class="longhuIntegrate">
        ...
        <div v-for="(item1, index) in gameList" :key="'row1'+index" style="overflow:hidden;">
            ...
            <div style="width:20%;float:left;border-right: 1px solid #c9c7c7;border-bottom: 1px solid #c9c7c7;cursor: pointer;" v-for="(item2, pos) in item1.groupSettinges" :key="pos"  :style="{backgroundColor: playModel=='快捷' && item2.selected ? '#FFF8B6': 'white'}" @click="item2.selected = (playModel!='快捷' ? false : !item2.selected);item2.betAmt = item2.betAmt >0 ? '' : kuaijiejine">
