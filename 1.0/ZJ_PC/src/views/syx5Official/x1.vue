	...
	export default {
		...
		methods: {
			...
			validChioceNum(){ //是否完成有效投注
				...
				if (this.settings.groupNo.toString().slice(4) == '11003322' && this.codeNumYardArr[0].length > 0) valid = true;
				if (this.settings.groupNo.toString().slice(4) == '22002222' && this.codeNumYardArr[0].length > 1) valid = true;
				if (this.settings.groupNo.toString().slice(4) == '22003322' && this.codeNumYardArr[0].length > 1) valid = true;
				if (this.settings.groupNo.toString().slice(4) == '33002222' && this.codeNumYardArr[0].length > 2) valid = true;
				if (this.settings.groupNo.toString().slice(4) == '33003322' && this.codeNumYardArr[0].length > 2) valid = true;
				if (this.settings.groupNo.toString().slice(4) == '44001122' && this.codeNumYardArr[0].length > 3) valid = true;
				if (this.settings.groupNo.toString().slice(4) == '55001122' && this.codeNumYardArr[0].length > 4) valid = true;
				if (this.settings.groupNo.toString().slice(4) == '66001122' && this.codeNumYardArr[0].length > 5) valid = true;
				if (this.settings.groupNo.toString().slice(4) == '77001122' && this.codeNumYardArr[0].length > 6) valid = true;
				if (this.settings.groupNo.toString().slice(4) == '88001122' && this.codeNumYardArr[0].length > 7) valid = true;
				if (this.settings.groupNo.toString().slice(4) == '99002211' && this.codeNumYardArr[0].length > 0) valid = true;
