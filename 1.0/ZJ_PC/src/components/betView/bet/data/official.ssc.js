...
const dataFun = function(arg,Amt){
  ...
  const data =  {
    ...
    111155001111: {
      description: "手动输入号码，至少输入1个五位数号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      ...
      format: ["n,n,n,n,n"],
      name: "五星直选单式",
      component: 'before2single',
      betInitMoney: 2
    },
    111155001122: {
      description: "从万位、千位、百位、十位、个位中选择一个5位数号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      example: "投注方案：23456；<br>开奖号码：23456，<br>即中五星直选。",
      rule: "从万位、千位、百位、十位、个位中选择一个5位数号码组成一注，所选号码与开奖号码全部相同，且顺序一致，即为中奖。",
      tpl: "num1",
      sub: [
        {unit:"万位",golbal:[1,10],btn : true},
        {unit:"千位",golbal:[1,10],btn : true}, 
        {unit:"百位",golbal:[1,10],btn : true}, 
        {unit:"十位",golbal:[1,10],btn : true}, 
        {unit:"个位",golbal:[1,10],btn : true}, 
      ],
      algorithm: ["R1"],
      code:111155001122,
      format: ["n|n|n|n|n"],
      ...
      name: "五星直选复式",
      component: 'fiveStarRepet',
      betInitMoney: 2
    },
    111155001133: {
      description: "从个、十、百、千、万位各选一个号码组成五注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111155002211: {
      description: "从0-9中选择5个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      example: "投注方案：02568，开奖号码的五个数字只要包含0、2、5、6、8，即可中五星组选"+bonusAmt+"一等奖。",
      rule: "从0-9中任意选择5个号码组成一注，所选号码与开奖号码的万位、千位、百位、十位、个位相同，顺序不限，即为中奖。",
      tpl: "num1",
      sub: [
        {unit:"",golbal:[1,10],btn : true}, 
      ],
      code:111155002211,
      algorithm: [5,1,5,120],
      ...
      rank: ["5star120"],
      name: "五星组选120",
      component: 'fiveGrounp',
      betInitMoney: 2
    },
    111155002222: {
      description: "从“二重号”选择一个号码，“单号”中选择三个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      ...
      tpl: "num1",
      sub: [
        {unit:"二重号",golbal:[1,10],btn : true}, 
        {unit:"单号",golbal:[1,10],btn : true}, 
      ],
      code:111155002222,
      algorithm: [5,1,3,60],
    ...
    111155002233: {
      description: "从“二重号”选择两个号码，“单号”中选择一个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111155002244: {
      description: "从“三重号”选择一个号码，“单号”中选择两个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111155002255: {
      description: "从“三重号”选择一个号码，“二重号”中选择一个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111155002266: {
      description: "从“四重号”选择一个号码，“单号”中选择一个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111144111111: {
      description: "手动输入号码，至少输入1个四位数号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111144111122: {
      description: "从万位、千位、百位、十位中至少各选择一个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111144111133: {
      description: "在万位、千位、百位、十位任意位置上任意选择1个或1个以上号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111144112211: {
      description: "从0-9中选择4个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111144112222: {
      description: "从“二重号”选择一个号码，“单号”中选择两个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111144112233: {
      description: "从“二重号”选择两个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111144112244: {
      description: "从“三重号”选择一个号码，“单号”中选择一个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111144221111: {
      description: "从千位、百位、十位、个位中至少各选择一个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      example: "投注方案：3456，开奖号码：3456，即中四星直选。",
    ...
    111144221133: {
      description: "在千位、百位、十位、个位任意位置上任意选择1个或1个以上号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111133331111: {
      description: "手动输入号码，至少输入1个三位数号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111133331122: {
      description: "从个、十、百位各选一个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111133331133: {
      description: "从0-27中任意选择1个或1个以上号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      ...
      code: 111133331133,
      sub: [
        {unit:"",golbal:[1,28],btn : false}, 
      ],
      algorithm: ["R4", 3, 0, 9],
      rank: ["after3_d_sum"],
      name: "后三直选和值",
      yardWarehouse: [{'num': 0,'yard': 1},{'num': 1,'yard': 3},{'num': 2,'yard': 6},{'num': 3,'yard': 10},
      {'num': 4,'yard': 15},{'num': 5,'yard': 21},{'num': 6,'yard': 28},{'num': 7,'yard': 36},
      {'num': 8,'yard': 45},{'num': 9,'yard': 55},{'num': 10,'yard': 63},{'num': 11,'yard': 69},
      {'num': 12,'yard': 73},{'num': 13,'yard': 75},{'num': 14,'yard': 75},{'num': 15,'yard': 73},
      {'num': 16,'yard': 69},{'num': 17,'yard': 63},{'num': 18,'yard': 55},{'num': 19,'yard': 45},
      {'num': 20,'yard': 36},{'num': 21,'yard': 28},{'num': 22,'yard': 21},{'num': 23,'yard': 15},
      {'num': 24,'yard': 10},{'num': 25,'yard': 6},{'num': 26,'yard': 3},{'num': 27,'yard': 1}],
      component: 'after3directSum',
      betInitMoney: 2
    },
    111133332211: {
      description: "从0-9中任意选择2个或2个以上号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111133332222: {
      description: "从0-9中任意选择3个或3个以上号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111133332244: {
      description: "手动输入号码，至少输入1个三位数号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111133332233: {
      description: "从1-26中选择1个号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      ...
      code:111133332233,
      sub: [
        {unit:"",golbal:[0,26],btn : false}, 
      ],
      algorithm: ["R4", 3, 0, 9, "C"],
      rank: ["after3_c_sum"],
      name: "后三组选和值",
      yardWarehouse: [{'num': 1,'yard': 1},{'num': 2,'yard': 2},{'num': 3,'yard': 2},
      {'num': 4,'yard': 4},{'num': 5,'yard': 5},{'num': 6,'yard': 6},{'num': 7,'yard': 8},
      {'num': 8,'yard': 10},{'num': 9,'yard': 11},{'num': 10,'yard': 13},{'num': 11,'yard': 14},
      {'num': 12,'yard': 14},{'num': 13,'yard': 15},{'num': 14,'yard': 15},{'num': 15,'yard': 14},
      {'num': 16,'yard': 14},{'num': 17,'yard': 13},{'num': 18,'yard': 11},{'num': 19,'yard': 10},
      {'num': 20,'yard': 8},{'num': 21,'yard': 6},{'num': 22,'yard': 5},{'num': 23,'yard': 4},
      {'num': 24,'yard': 2},{'num': 25,'yard': 2},{'num': 26,'yard': 1}],
      component: 'after3directSum',
      betInitMoney: 2
    },
    111133111111: {
    ...
    111133111122: {
      description: "从万、千、百位各选一个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      example: "投注方案：345； 开奖号码：345，即中前三直选一等奖",
    ...
    111133112233: {
      description: "从1-26中任意选择1个以上号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111133221122: {
      description: "从千、百、十位各选一个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111133221133: {
      ...
      vm: "num1",
      sub: [
        {unit:"直选和值",golbal:[1,28],btn : false}, 
      ],
      algorithm: ["R4", 3, 0, 9],
      rank: ["middle3_d_sum"],
      name: "中三直选和值",
    ...
    111133222233: {
      description: "从1-26中选择1个和值。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      ...
      vm: "num1",
      sub: [
        {unit:"组选和值",golbal:[0,26],btn : false}, 
      ],
      code: 111133222233,
      algorithm: ["R4", 3, 0, 9, "C"],
      rank: ["middle3_c_sum"],
    ...
    111122221122: {
      description: "从十、个位各选一个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111122221111: {
      description: "手动输入号码，至少输入1个两位数号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      example: "投注方案：58；开奖号码后二位：58，即中后二直选一等奖",
    ...
    111122111122: {
      description: "从万、千位各选一个号码组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111122221133: {
      description: "从0-18中任意选择1个或1个以上的和值号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      example: "投注方案：和值1；开奖号码后二位：01,10，即中后二直选。",
      rule: "所选数值等于开奖号码的十位、个位二个数字相加之和，即为中奖。",
      tpl: "hezhi1",
      vm: "num1",
      sub: [
        {unit:"和值",golbal:[1,19],btn : false}, 
      ],
      code:111122221133,
      repeat: true,
      algorithm: 2,
    ...
    111122222233: {
      description: "从1-17中任意选择1个或1个以上的和值号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      example: "投注方案：和值1；开奖号码后二位：10或01(顺序不限，不含对子号)，即中后二组选。",
      rule: "所选数值等于开奖号码的十位、个位二个数字相加之和（不含对子号），即为中奖。",
      tpl: "hezhi1",
      vm: "num1",
      sub: [
        {unit:"和值",golbal:[0,17],btn : false}, 
      ],
      code:111122222233,
      algorithm: 2,
      repeat: false,
    ...
    111122112233: {
      description: "从1-17中任意选择1个或1个以上号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    1111110044: { 
      description: "在万位，千位，百位，十位，个位任意位置上任意选择1个或1个以上号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      example: "投注万位号码1，开奖号码万位是1，即中定位胆万位一等奖。",
      rule: "从万位、千位、百位、十位、个位任意位置上至少选择1个以上号码，所选号码与相同位置上的开奖号码一致，即为中奖。",
      tpl: "num1",
      code:1111110044,
      sub:[
        {unit:"万位",golbal:[1,10],groupNo:111111004411,btn : true}, 
        {unit:"千位",golbal:[1,10],groupNo:111111004422,btn : true}, 
        {unit:"百位",golbal:[1,10],groupNo:111111004433,btn : true}, 
        {unit:"十位",golbal:[1,10],groupNo:111111004444,btn : true}, 
        {unit:"个位",golbal:[1,10],groupNo:111111004455,btn : true}
      ],
    ...
    111100002211: {
      description: "从0-9中任意选择1个以上号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
      example: "投注方案：1；开奖号码后三位：至少出现1个1，即中后三一码不定位一等奖。",
      rule: "从0-9中选择1个号码，每注由1个号码组成，只要开奖号码的百位、十位、个位中包含所选号码，即为中奖。",
      tpl: "num1",
      sub: [
        {unit:"不定胆",golbal:[1,10],btn : true},
      ],
      algorithm: 1,
      code: 111100002211,
      format: ["n"],
    ...
    111100002222: {
      description: "从0-9中任意选择2个以上号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111199000022: {
      description: "从十位、个位中的“大、小、单、双”中至少各选一个组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111199000011: {
      description: "从万位、千位中的“大、小、单、双”中至少各选一个组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111166000022: {
      description: "从0-9中任意选择1个以上的二重号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111166000033: {
      description: "从0-9中任意选择1个以上的三重号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111166000044: {
      description: "从0-9中任意选择1个以上的四重号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111122001122: {
      description: "从万位、千位、百位、十位、个位中至少两位上各选1个号码组成1注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111133001122: {
      description: "从万位、千位、百位、十位、个位中至少三位上各选1个号码组成1注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111144001122: {
      description: "从万位、千位、百位、十位、个位中至少四位上各选1个号码组成1注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111144002244: {
      description: "从三重号选1个号，单号中选1个号组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111144002233: {
      description: "从二重号中选择2个号组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111144002222: {
      description: "从二重号中选1个号，单号中选2个号组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    111144002211: {
      description: "从单号中选4个号组成一注。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    3145: {
      description: "从0-9中选择1个号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
    ...
    3152: {
      description: "从0-9中任意选择3个以上号码。奖金<span style='color: #e60b0b;'>"+bonusAmt+"</span>元",
