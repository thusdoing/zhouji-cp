...
export default {
  ...
  methods:{
    ...
    validChioceNum(){ //是否完成有效投注
      ...
      if(this.settings.groupNo.toString().slice(4) == '33332211' && this.codeNumYardArr[0].length > 1) valid = true;
      if(this.settings.groupNo.toString().slice(4) == '33332222' && this.codeNumYardArr[0].length > 2)  valid = true;
      if(this.settings.groupNo.toString().slice(4) == '33112211' && this.codeNumYardArr[0].length > 1) valid = true;
      if(this.settings.groupNo.toString().slice(4) == '33112222' && this.codeNumYardArr[0].length > 2)  valid = true;
      if(this.settings.groupNo.toString().slice(4) == '33222211' && this.codeNumYardArr[0].length > 1) valid = true;
      if(this.settings.groupNo.toString().slice(4) == '33222222' && this.codeNumYardArr[0].length > 2)  valid = true;
...
<style scoped>
.play-box .play-content .play-content-list .label .icon-decoration_icon{margin-right: 0 !important}
</style>
