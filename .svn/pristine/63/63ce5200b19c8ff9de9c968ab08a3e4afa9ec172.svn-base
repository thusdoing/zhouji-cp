...
<template>
  <view-box class="register">
    <div class="isShow">    
      ...
      <check-icon :value.sync="isAdult" type="plain" style="background-color:#ffffff; margin-top: 8px; padding:8px;width:100%;">我已同意用户协议<a style="color:red;" href="#" @click="xieYi">《{{$ENV.VUE_APP_NAME}}协议》</a></check-icon>
