...
<template>
  <div style="width: 100%; height:100%">
    ...
    <drawer v-else :show.sync="isShowMore" class="bet-lottery" placement="right" :drawer-style="{width: '240px'}" >
      ...
      <view-box body-padding-top="60px" body-padding-bottom="0" class="viewbox">
        ...
        <BetLotteryPanel slot="header" :key="gameNo + 2" class="panel"/>
    ...
    <confirm v-if="'betConfirmKey' === props.key" v-model="props.visible" title="提示" @on-confirm="props.onConfirm">
      <p style="text-align:left;color:#666;"> 第 <span style="color:red">{{ lottery.nextOpenGame.gameNumber }}</span> 期 </p>
      ...
      <p style="text-align:left;color:#666;">
        <span style="color:red" v-text="betNumber"></span> 注 <span style="color:red" v-text="betTimes"></span> 倍，共
