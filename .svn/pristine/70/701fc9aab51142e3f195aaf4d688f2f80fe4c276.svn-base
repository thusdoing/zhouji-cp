        ...
        <div v-if="paydata.length!=0" class="_3JgUR">
            <form>
                ...
                <div v-if="paydata[bankIndex]" class="_29oRb mb10">
                    <div class="_2w01D" style="width: 80px;border-radius: 20px">线下转账</div><span style="color: #f46e00">支持网银转账，ATM转账，银行柜台汇款</span>
                    
                    <div class="_3Lpio" style="position: relative;">
                        <!-- <img id="imgewm" v-if="getData[bankIndex].qrCodeImg" :src="getData[bankIndex].qrCodeImg"> -->
                        <label class="v-mid U87la">收款账户 : </label>
                        <div class="_19tvw _39aPw before-vertical">
                            ...
                            <div v-for="(item,index) in paydata" class="dib v-mid QuSiB">
                                ...
                                <label @click="selebankIndex(index)" class="U87la before-vertical relative" :for="index">
                                    ...
                                    <span class="v-mid overflow-hidden mr8">{{item.sysBankName}}</span>
                ...
                <div class="_29oRb">
                    ...
                    <div class="Vxtwm jRinb" v-html="paydata[bankIndex].bankRemark">
                            ※ 温馨提示：
                            <br> 1、请认真填写您的转账信息：请务必转账后再提交订单,否则无法及时查到您的款项！
                            <br> 2、转账 1 笔提交 1 次，请勿重复提交订单。
                    </div>
                    <table v-if="paydata[bankIndex]" class="mt12 _2KMyk">
                        <tbody>
                            <tr>
                                ...
                                <td class="_2_V64" v-clipboard:copy="paydata[bankIndex].sysBankName" v-clipboard:success="fuzhi" v-clipboard:error="shibai">复制</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td id="BankAccount" class="_3xEkI">{{paydata[bankIndex].sysBankNo}}</td>
                                <td class="_2_V64" v-clipboard:copy="paydata[bankIndex].sysBankNo" v-clipboard:success="fuzhi" v-clipboard:error="shibai">复制</td>
                            </tr>
                            <tr>
                                <td style="text-align: right;padding-right: 20px;line-height: 44px">开户支行 : </td>
                                <td id="Branch" class="_3xEkI">{{paydata[bankIndex].sysOpenBankName}}</td>
                                <td class="_2_V64" v-clipboard:copy="paydata[bankIndex].sysOpenBankName" v-clipboard:success="fuzhi" v-clipboard:error="shibai">复制</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: right;padding-right: 20px;line-height: 44px">存款人姓名 : </td>
                                <td id="Branch" class="_3xEkI"><input type="text" class="_1iDCE s1cJ-" name="bankCardName" placeholder="请正确填写您的名字" v-model='formData.custName'></td>
                            </tr>
                        </tbody>
                    </table>
            ...
            methods:{
                ...
                toOnlinePay(){
                    ...
                    if(min<=this.formData.payMoney&&this.formData.payMoney<=max){
                        ...
                        if(!this.once){return}
                        this.once=false
                        this.formData.methodId = this.paydata[this.bankIndex].bankId
