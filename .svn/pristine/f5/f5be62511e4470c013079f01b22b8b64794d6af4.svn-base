...
<template>
    <div id="rightscroller" class="fixed flag-show" :style="'z-index: 1001; top: 50%; transform: translateY(-50%) scale(1); transition: transform 300ms linear; right: '+10+'px;'">
        ...
        <a class="disb click1" @click="onlineKefu"></a>
        <a class="disb click2" @click="lxqq"></a>
        <p class="disb click9" @click="lxqq">{{qqKeFu.match( new RegExp('uin=(.*?)&Site'))[1]}}</p>
         <a class="disb click6" href="#/register"></a>
          <a class="disb click7" href="#"></a>
           <a class="disb click8" href="/"></a>
        <!-- <a class="disb click3">
            <vueQR :text="url" :margin="10" style="height: 64px; width: 64px;margin: auto"></vueQR>
        </a> -->
