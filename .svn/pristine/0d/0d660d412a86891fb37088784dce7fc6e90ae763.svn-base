        ...
        <Row>
            <i-col span="24">
                <div class="longhuIntegrateHeader">
                    ...
                    <div style="line-height: 41px;font-weight: bold;">快捷金额设置：<Input v-model="kuaijiejine" type="text" v-integer class="kuaijie" size="small" style="width: 60px;"></Input> 元
                    <span>
                ...
                <Row class="aaa" :class="item2.betAmt >0 ?'active':''">
                    <i-col :span="playModel=='一般' ? 7 : 12">
                        <p style="text-align:center;margin-bottom:5px;line-height:36px;">
                            ...
                            <img style="width:20px;height:20px;vertical-align: middle;margin-left:2px;" v-else v-for="(bj,bjindex) in item2.groupName.split('')" :src="`/static_pc/images/saizi/sn${bj}.png`" :key="bjindex">
                        </p>
                    </i-col>
                    <i-col :span="playModel=='一般' ? 7 : 12" >
                        <p style="font-size:13px;text-align:center;margin-bottom:5px;color:red;line-height:36px;">{{gameBoundList[index][pos].bonusAmt || '-'}}</p>
                    </i-col>
                    <i-col :span="10" v-if="playModel=='一般'">
