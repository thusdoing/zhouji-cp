...
@import "./PK10Simplex.less";
.pk10-simplex { width: 100%; height: 100%; }
</style>

<template>
  <div class="pk10-simplex">
...
@Component
export default class PK10Simplex extends Vue {
  @Inject() lottery;
  @Inject() pk10;
  ...
  get config () {
    return this.pk10.config;
  }
  get settings () {
    return this.pk10.settings;
  }
  get pattern () {
