...
const dataFun = function (arg, Amt) {
  ...
  const data = {
    ...
    [`${gameNo}221111`]: {
      ...
      code: gameNo + 221111,
      sub: [
        { unit: '冠军', golbal: [0, 10], groupNo: gameNo + 22111101, btn: true },
        { unit: '亚军', golbal: [0, 10], groupNo: gameNo + 22111102, btn: true },
        { unit: '季军', golbal: [0, 10], groupNo: gameNo + 22111103, btn: true },
        { unit: '第四', golbal: [0, 10], groupNo: gameNo + 22111104, btn: true },
        { unit: '第五', golbal: [0, 10], groupNo: gameNo + 22111105, btn: true },
        { unit: '第六', golbal: [0, 10], groupNo: gameNo + 22111106, btn: true },
        { unit: '第七', golbal: [0, 10], groupNo: gameNo + 22111107, btn: true },
        { unit: '第八', golbal: [0, 10], groupNo: gameNo + 22111108, btn: true },
        { unit: '第九', golbal: [0, 10], groupNo: gameNo + 22111109, btn: true },
        { unit: '第十', golbal: [0, 10], groupNo: gameNo + 22111110, btn: true }
      ],
      algorithm: '1',
      format: ['n'],
      rank: [0, 1, 2, 3, 4],
    ...
    [`${gameNo}33111111`]: {
      ...
      rule: '从万位、千位、百位、十位、个位任意位置上至少选择1个以上号码，所选号码与相同位置上的开奖号码一致，即为中奖。',
      tpl: 'num1',
      code: gameNo + 33111111,
      sub: [
        { unit: '冠军', golbal: [0, 10], groupNo: gameNo + 33111111, btn: true }
      ],
      algorithm: '1',
      format: ['n'],
      rank: [0, 1, 2, 3, 4],
