...
if (typeof storage.RSAUtils == 'undefined') { var RSAUtils = storage.RSAUtils = {}; }
...
let BigInt = storage.BigInt = function (flag) {
...
RSAUtils.setMaxDigits = function (value) {
  ...
  bigZero = new storage.BigInt();
  bigOne = new storage.BigInt();
  bigOne.digits[0] = 1;
};
...
RSAUtils.biCopy = function (bi) {
  let result = new storage.BigInt(true);
...
storage.BarrettMu = function (m) {
  this.modulus = RSAUtils.biCopy(m);
  this.k = RSAUtils.biHighIndex(this.modulus) + 1;
  let b2k = new storage.BigInt();
  b2k.digits[2 * this.k] = 1; // b2k = b^(2k)
  this.mu = RSAUtils.biDivide(b2k, this.modulus);
  this.bkplus1 = new storage.BigInt();
...
let RSAKeyPair = function (encryptionExponent, decryptionExponent, modulus) {
  ...
  this.radix = 16;
  this.barrett = new storage.BarrettMu(this.m);
};
...
if (typeof storage.twoDigit == 'undefined') {
  storage.twoDigit = function (n) {
